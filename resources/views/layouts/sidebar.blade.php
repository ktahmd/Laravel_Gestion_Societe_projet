<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
           ...
           <li><a href="{{ url('/user') }}"><i class="fa fa-user-secret"></i> <span>System Utilisateurs</span></a></li> 
           <li><a href="{{ url('/client') }}"><i class="fa fa-users"></i> <span>System Clients</span></a></li>
